...
export default {
  ...
  effects: {
    *getData({payload},{call,put}){
      let fullYearData=yield call(getSalaryByYear,{year:new Date().getFullYear(),usercode:window.localStorage.getItem(usernameKey)})
    ...
    *searchData({payload},{call,put,select}){
     let column=[
      ...
      console.log('search:'+JSON.stringify(search.data));
